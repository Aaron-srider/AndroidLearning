...
public class WordsDBHelper extends SQLiteOpenHelper {
    ...
    private final static String SQL_CREATE_DATABASE =
            "CREATE TABLE "
                    ...
                    " (" + Words.Word._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + Words.Word.COLUMN_NAME_WORD + " TEXT" + "," + Words.Word.COLUMN_NAME_MEANING + " TEXT" + "," + Words.Word.COLUMN_NAME_SAMPLE + " TEXT" + " )";
