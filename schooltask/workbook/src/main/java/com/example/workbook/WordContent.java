...
public class WordContent {
     ...
     */
    public static final List<WordContent.WordItem> ITEMS = new ArrayList<WordItem>();

    /**
     * A map of sample (placeholder) items, by ID.
     */
    public static final Map<String, WordContent.WordItem> ITEM_MAP = new HashMap<String, WordItem>();
